...
public static class Recorder
{
    ...
    {
        // force two garbage collections to release mentory that is
        // no longer referenced but has botbeen released yet
        GC.Collect();
    ...
    public static void Stop()
    {
        ...
        long bytesVirtualAfter = GetCurrentProcess().PeakVirtualMemorySize64;
